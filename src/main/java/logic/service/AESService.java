...
public class AESService {
	 ...
	 * @return 暗号化文字列
	 */
	public static String encrypt(String text, PropfileDao envDao) {
		// 変数初期化
		...
		try {
			...
			byte[] byteKey = envDao.getString("SECRET_KEY").getBytes("UTF-8");
			byte[] byteIv = envDao.getString("INIT_VECTOR").getBytes("UTF-8");
	 ...
	 * @return 復号化文字列
	 */
	public static String decrypt(String text, PropfileDao envDao) {
		// 変数初期化
		String strResult = null;
